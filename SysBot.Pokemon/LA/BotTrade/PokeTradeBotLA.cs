...
public class PokeTradeBotLA(PokeTradeHub<PA8> Hub, PokeBotState Config) : PokeRoutineExecutor8LA(Config), ICountBot
{
    ...
    private async Task<PokeTradeResult> ProcessEtumrepTradeAsync(PokeTradeDetail<PA8> detail, CancellationToken token)
    {
        ...
        [
            (ushort)Species.Abra, (ushort)Species.Kadabra, (ushort)Species.Drifloon, (ushort)Species.Drifblim,
            (ushort)Species.Aipom, (ushort)Species.Drifloon, (ushort)Species.Drifblim
            (ushort)Species.Basculin, (ushort)Species.Drifloon, (ushort)Species.Drifblim,
            (ushort)Species.Beautifly, (ushort)Species.Dustox, (ushort)Species.Mothim,
            (ushort)Species.Bidoof, (ushort)Species.Eevee, (ushort)Species.Drifloon
            (ushort)Species.Bidoof, (ushort)Species.Ponyta, (ushort)Species.Drifloon,
            (ushort)Species.Bronzor, (ushort)Species.Bronzong,
            (ushort)Species.Budew, (ushort)Species.Roselia, (ushort)Species.Ralts, (ushort)Species.Gastly, (ushort)Species.Haunter,
            (ushort)Species.Buizel, (ushort)Species.Drifloon,
            (ushort)Species.Buneary, (ushort)Species.Psyduck,
            (ushort)Species.Buneary, (ushort)Species.Zubat,
            (ushort)Species.Buneary, (ushort)Species.Drifloon,
            (ushort)Species.Chimchar, (ushort)Species.Monferno, (ushort)Species.Starly, (ushort)Species.Staravia,
            (ushort)Species.Chimchar, (ushort)Species.Monferno, (ushort)Species.Zubat, (ushort)Species.Golbat,
            (ushort)Species.Combee, (ushort)Species.Zubat, (ushort)Species.Golbat,
            (ushort)Species.Croagunk, (ushort)Species.Toxicroak, (ushort)Species.Gastly, (ushort)Species.Haunter,
            (ushort)Species.Geodude, (ushort)Species.Zubat,
            (ushort)Species.Geodude, (ushort)Species.Gastly, (ushort)Species.Haunter,
            (ushort)Species.Glameow, (ushort)Species.Purugly,
            (ushort)Species.Gligar,
            (ushort)Species.Happiny, (ushort)Species.Chansey, (ushort)Species.Machop, (ushort)Species.Machoke,
            (ushort)Species.Hippopotas, (ushort)Species.Hippowdon, (ushort)Species.Gastly, (ushort)Species.Haunter,
            (ushort)Species.Kricketot, (ushort)Species.Munchlax, (ushort)Species.Zubat,
            (ushort)Species.Kricketot, (ushort)Species.Pichu, (ushort)Species.Pikachu, (ushort)Species.Zubat, (ushort)Species.Golbat,
            (ushort)Species.Magikarp, (ushort)Species.Gyarados,
            (ushort)Species.Mime-Jr, (ushort)Species.Wurmple, (ushort)Species.Drifloon,
            (ushort)Species.Mime-Jr, (ushort)Species.Mr-Mime, (ushort)Species.Drifloon, (ushort)Species.Drifblim,
            ...
            (ushort)Species.Pichu, (ushort)Species.Wurmple, (ushort)Species.Drifloon,
            (ushort)Species.Qwilfish, (ushort)Species.Drifloon, (ushort)Species.Drifblim,
            (ushort)Species.Ralts, (ushort)Species.Kirlia, (ushort)Species.Gastly, (ushort)Species.Haunter, (ushort)Species.Spiritomb,
            (ushort)Species.Rufflet,
            (ushort)Species.Shellos, (ushort)Species.Gastrodon,
            (ushort)Species.Shinx, (ushort)Species.Luxio, (ushort)Species.Luxray, (ushort)Species.Drifloon, (ushort)Species.Drifblim,
            (ushort)Species.Stantler, (ushort)Species.Zubat
            (ushort)Species.Starly, (ushort)Species.Staravia, (ushort)Species.Staraptor, (ushort)Species.Drifloon, (ushort)Species.Driflblim,
            (ushort)Species.Swinub, (ushort)Species.Piloswine, (ushort)Species.Duskull, (ushort)Species.Dusclops,
            ...
            (ushort)Species.Wurmple, (ushort)Species.Cascoon, (ushort)Species.Silcoon, (ushort)Species.Zubat, (ushort)Species.Golbat,
        ];
