...
public class PokeTradeBotLA(PokeTradeHub<PA8> Hub, PokeBotState Config) : PokeRoutineExecutor8LA(Config), ICountBot
{
    ...
    private async Task<PokeTradeResult> ProcessEtumrepTradeAsync(PokeTradeDetail<PA8> detail, CancellationToken token)
    {
        ...
        [
            ...
            (ushort)Species.Buizel, (ushort)Species.Drifloon, (ushort)Species.Zubat,
            (ushort)Species.Buneary, (ushort)Species.Psyduck, (ushort)Species.Drifloon, (ushort)Species.Zubat,
            (ushort)Species.Chimchar, (ushort)Species.Monferno, (ushort)Species.Starly, (ushort)Species.Staravia, (ushort)Species.Zubat, (ushort)Species.Golbat,
            ...
            (ushort)Species.Geodude, (ushort)Species.Gastly, (ushort)Species.Haunter, (ushort)Species.Zubat,
            ...
            (ushort)Species.MimeJr, (ushort)Species.MrMime, (ushort)Species.Wurmple, (ushort)Species.Drifloon,
            ...
            (ushort)Species.Wurmple, (ushort)Species.Cascoon, (ushort)Species.Silcoon, (ushort)Species.Beautifly, (ushort)Species.Dustox, (ushort)Species.Zubat, (ushort)Species.Golbat,
        ];
