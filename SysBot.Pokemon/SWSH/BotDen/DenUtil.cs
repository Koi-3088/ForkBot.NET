...
#pragma warning disable CS8629 // Nullable value type may be null.
        for (int i = 0; i < length; i++)
        {
            ...
            var probList = isEvent ? [.. raidInfo.RaidDistributionEncounterTable.Entries(i).Value.GetProbabilitiesArray()] : raidInfo.RaidEncounterTable.Entries(i).Value.GetProbabilitiesArray().ToList();
